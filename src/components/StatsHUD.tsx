  ...
  const statItems = [
    {
      id: 'education',
      label: 'IIT KHARAGPUR',
      value: profile.education ? `${profile.education.cgpa.split('/')[0].trim()} CGPA` : '8.48 CGPA',
      detail: profile.education?.minor
        ? `AI Minor • ${profile.education.year}`
        : (profile.education?.degree ?? 'Ocean Engg. (Hons)'),
      color: 'text-[#38bdf8]',
    ...
    },
    {
      id: 'class',
      label: 'PLAYER CLASS',
      value: profile.stats.class.toUpperCase(),
